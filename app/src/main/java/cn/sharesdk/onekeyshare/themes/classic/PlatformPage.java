...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		llPage.setGravity(Gravity.CENTER_VERTICAL);//修改分享对话框位置
		...
		lp = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, adapter.getPanelHeight());
		llPanel.addView(mvp, lp);

		IndicatorView vInd = new IndicatorView(activity);
		lp = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, adapter.getBottomHeight());
